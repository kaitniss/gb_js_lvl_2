...
const app = new Vue({
    el: '#app', //контроллируем блок див с ид app
    data: {
        userSearch: '',
        isVisibleCart: false,
        catalogUrl: '/catalogData.json', //ссылка на каталог с массивом товаров
        cartUrl: '/getBasket.json',
        cartItems: [],
        filtered: [],
        imgCart: 'https://placehold.it/50x70',
        products: [],
        imgCatalog: 'https://placehold.it/200x150', //заглушка фото товара
        isSubmitted: false
    },
    methods: {
        getJson(url){
...
//        this.cart = cart;
//        this.getJson()
//            .then(data => this.handleData(data));//handleData запускает отрисовку либо каталога товаров, либо
//            списка товаров корзины
//    }
//    _init(){
